...
function getFormattedBody(args) {
    ...
    throw new Error("Illegal argument: number, string, null or array required.")
}
...
function getObjectFromRawBody(rawBody) {
    ...
    if(!["n", "t", "i", "ai", "at"].includes(identifier)) throwFormatError(text, "identifier")
...
exports.splitPyMessage = splitPyMessage;
